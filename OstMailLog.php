 ...
 *
 * Adds a mail archive for every email sent via shopware in the backend.
 *
 * 1.0.0
 * - initial release
 *
...
class OstMailLog extends Plugin
{
    ...
    public function build(ContainerBuilder $container)
    {
        ...
        $container->setParameter('ost_mail_log.plugin_dir', $this->getPath() . '/');
        $container->setParameter('ost_mail_log.view_dir', $this->getPath() . '/Resources/views/');
